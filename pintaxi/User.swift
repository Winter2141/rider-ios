...
class User : NSObject, NSCoding, JSONSerializable {
    ...
    init(id : Int?, accessToken : String?, firstName : String?, lastName : String?, mobile : String?, country_code: String?, email : String?, currency : String?, picture : String?, refreshToken : String?, walletBalance : String?, sos : String?, loginType : String?, dispatcherNumber : String?, isBrainTreeAllowed : Bool, isPayumoneyAllowed : Bool, isPaytmAllowed : Bool, isCardAllowed : Bool, isCashAllowed : Bool, measurement : String?, stripeKey : String?,referral_count:String?,referral_unique_id:String?,referral_total_text:String?,referral_text:String?,otp:Int?,ride_otp:Int?, qrcode_url: String?, rating : String?){
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        let walletBalance = aDecoder.decodeObject(forKey: Keys.list.wallet) as? String
