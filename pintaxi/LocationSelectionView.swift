...
class LocationSelectionView: UIView {
    ...
    override func awakeFromNib() {
        ...
        self.initialLoads()
        self.setDesign()
        tableViewBottom.separatorColor = UIColor.clear
    }
}
...
extension LocationSelectionView {
    ...
    private func setDesign() {
        ...
        viewPickuo.layer.cornerRadius = viewPickuo.frame.size.height / 2
    ...
    private func localize() {
        ...
        self.textFieldSource.attributedPlaceholder = NSAttributedString(string:Constants.string.source.localize(), attributes:[NSAttributedString.Key.foregroundColor: UIColor.white,NSAttributedString.Key.font :UIFont(name: "Montserrat-SemiBold", size: 16)!])
        
        self.textFieldDestination.attributedPlaceholder = NSAttributedString(string:Constants.string.destination.localize(), attributes:[NSAttributedString.Key.foregroundColor: UIColor.white,NSAttributedString.Key.font :UIFont(name: "Montserrat-SemiBold", size: 16)!])

                
        textFieldSource.clearButtonMode = .whileEditing
        if let clearButton = textFieldSource.value(forKeyPath: "_clearButton") as? UIButton {
            clearButton.setImage(UIImage(named:"txtClose"), for: .normal)
            clearButton.setImage(UIImage(named:"txtClose"), for: .highlighted)
        }
        
        
        textFieldDestination.clearButtonMode = .whileEditing
        if let clearButton = textFieldDestination.value(forKeyPath: "_clearButton") as? UIButton {
            clearButton.setImage(UIImage(named:"txtClose"), for: .normal)
            clearButton.setImage(UIImage(named:"txtClose"), for: .highlighted)
        }
       }
