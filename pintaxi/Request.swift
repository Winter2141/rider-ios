...
class Request : JSONSerializable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        s_latitude = try? values.decode(String.self, forKey: .s_latitude)
        s_longitude = try? values.decode(String.self, forKey: .s_longitude)
        d_address = try? values.decode(String.self, forKey: .d_address)
        d_latitude = try? values.decode(String.self, forKey: .d_latitude)
        d_longitude = try? values.decode(String.self, forKey: .d_longitude)
        ...
        user = try? values.decode(UserDetails.self, forKey: .user)
        ...
        total_payment = try? values.decode(String.self, forKey: .total_payment)
        payment_id = try? values.decode(String.self, forKey: .payment_id)
