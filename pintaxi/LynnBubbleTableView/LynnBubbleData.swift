...
public class LynnUserData :NSObject {
    ...
    private(set) public var userNickName:String?
     private(set) public var msgTime:String?
    public var userInfo: AnyObject?
    
    init(userUniqueId userId:String, userNickName nick:String? = nil , msgTime time:String? = nil , userProfileImage profileImg:UIImage? = nil, additionalInfo userInfo:AnyObject? = nil) {
